...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def init_model(self):
        ...
        if self._is_ref:
            ...
            if self._is_actor:
                ...
                diagnostics_cfg = self.config.actor.get("sdpo_diagnostics", {})
                loss_mode = self.config.actor.policy_loss.get("loss_mode", "vanilla")
                if self_distillation_cfg is not None and (
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            if "cspd_topk_log_probs" in outputs:
                tensors["cspd_topk_log_probs"] = outputs["cspd_topk_log_probs"]
                tensors["cspd_topk_indices"] = outputs["cspd_topk_indices"]
