...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: str | list[str] = "console", config=None, group_name=None):
        ...
        if "swanlab" in default_backend:
            ...
            # SwanLab >=0.7 uses online/local/offline/disabled; keep "cloud" as alias.
            ...
            # Empty string must not be passed: newer swanlab Settings rejects id="".
            if swanlab_run_id:
                swanlab_init_kwargs["id"] = swanlab_run_id
                swanlab_init_kwargs["resume"] = os.environ.get("SWANLAB_RESUME", "must")
